...
def make_df(search_list, channel_list, count_list, viewcount):
    ...
    # 埋め込み動画のURL
    youtube_data['url'] = 'https://www.youtube.com/embed/' + \
        youtube_data['videoid']
...
def make_related_df(related_list, channel_list, count_list):
    ...
    youtube_data['url'] = 'https://www.youtube.com/embed/' + \
        youtube_data['videoid']
    youtube_data['rivalurl'] = 'https://www.youtube.com/embed/' + \
        youtube_data['rivalvideoid']
...
class IndexView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            # 動画検索
            search_list = search_video(
                keyword, items_count, order, search_start, search_end)
            ...
            # 動画データをデータフレーム化する
            youtube_data = make_df(
                search_list, channel_list, count_list, viewcount)
...
class RelatedView(View):
    ...
    def post(self, request, *args, **kwargs):
        ...
        if form.is_valid():
            ...
            # ライバル動画を検索
            rivalvideo_list = search_rivalvideo(
                rival_channel_id,
                rival_items_count,
                rival_order,
                rival_search_start,
            ...
            # 関連動画を検索
            related_list = search_relatedvideo(
                rivalvideo_list, my_channel_id, related_items_count)
            ...
            # 動画データをデータフレーム化する
            youtube_data = make_related_df(
                related_list, channel_list, count_list)
